...
public class Util {
    ...
    /**
     * O metodo recebe como entrada um inteiro positivo no intervalo entre 1 e
     * 20, uma cadeia de caracteres desse comprimento, e um caracter. Caso o
     * comprimento seja invalido ou o tamanho da cadeia não seja igual ao
     * tamanho passado como parametro, retornar uma mensagem de erro. Se todos
     * os dados forem válidos, o metodo deve retornar a posição na cadeia em que
     * o caracter é encontrado pela primeira vez ou uma mensagem indicando que o
     * caracter não está presente na cadeia. 
     */
